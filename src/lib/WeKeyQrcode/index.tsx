...
const WeKeyQrcode = ({ ewmParams, successCallback, getImgApi, getQrcodeResultApi, tip, showResult = false, timeDelay = 3 }: WeKeyQrcodeProps) => {
        ...
        (resultData &&
          ...
          <>
            ...
            >
              ...
              {qrImgData && <img src={qrImgData.imgUrl} alt="" width={160} height={160} />}
            </div>
            <p
              className={'desc_tip'}
            >
              {(resultData && resultData.wekey_user) ?
                <>
                  <CheckCircleFilled
                    className={'icon'}
                  />
